...
io.on('connection', (socket) => {
    ...
    socket.on('botTurnComplete', (data) => {
        ...
        // ✅ CRITICAL FIX: IMMEDIATE turn progression - NO delays to prevent race conditions
        console.log(`🚨 CRITICAL: Emitting turnChanged IMMEDIATELY to prevent race conditions`);
