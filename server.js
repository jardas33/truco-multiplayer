...
io.on('connection', (socket) => {
    ...
    socket.on('playCard', (data) => {
        ...
        if (room.game.playedCards.length === 4) {
            ...
            if (nextRoundStarter && !nextRoundStarter.isBot) {
                ...
                // ✅ CRITICAL FIX: IMMEDIATE turn progression for round completion - NO delays
                console.log(`🚨 CRITICAL: Emitting turnChanged IMMEDIATELY for round completion to prevent race conditions`);
        ...
        if (targetPlayer.isBot) {
            ...
            // ✅ CRITICAL FIX: IMMEDIATE turn progression for human players - NO delays
            console.log(`🚨 CRITICAL: Emitting turnChanged IMMEDIATELY for human player to prevent race conditions`);
    ...
    socket.on('botTurnComplete', (data) => {
        ...
        // ✅ CRITICAL FIX: Add controlled pacing for turn progression
        console.log(`🎯 Adding controlled pacing for turn progression`);
        ...
        }, 2000); // 2 second delay for controlled pacing
    });
